...
export const Chat = () => {
  ...
  return (
    ...
    <div className="chat" onClick={() => setIsOpen(false)}>
      ...
      <span>{data.user?.displayName}</span></span>
        <div className="chatIcons">
          ...
          <button className='ChatMore' onClick={() => setIsOpen(true)}><img src={more} alt=""  /></button>
          {isOpen && (
            <div className='more'> 
                <a className='' href="#" onClick={() => setIsOpens(true)}>
