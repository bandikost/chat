...
export const Chat = () => {
  ...
  return (
    ...
    <div className="chat" >
      ...
      <span className={showImage ? 'show' : ''} onClick={handleImageClick}><img className={showImage ? 'show' : ''} onClick={handleImageClick} src={data.user?.photoURL} alt="" width={"50px"} style={{borderRadius: "50%"}}  />
