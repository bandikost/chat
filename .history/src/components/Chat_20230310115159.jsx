        ...
        <div className="chatIcons">
          ...
          {isOpen && (
            <div className='more'> 
              ...
              <a href='#' className='' onClick={() => setisOpenClear(!isOpenClear)}><img src={deleteChat} alt=""  /><span onClick={() => setIsOpen(!isOpen)}>Удалить чат</span></a>
              {isOpenClear && (
                <div className='moreClear'>
                  ...
                  <hr />
                   ...
                   <hr />
                      <a onClick={() => setisOpenClear(false)}>Нет</a>
                    </div>
                </div>
              )}
            </div>
