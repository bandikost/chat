...
import { arrayUnion as myArrayUnion, doc, serverTimestamp, updateDoc } from "firebase/firestore";
...
const Input = () => {
  ...
  const handleSend = async () => {
    ...
    await updateDoc(doc(db, "userChats", currentUser.uid), {
      ...
      [data.chatId + ".date"]: FieldValue.serverTimestamp(), // use serverTimestamp() with update()
    });
