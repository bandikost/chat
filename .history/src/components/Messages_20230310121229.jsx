...
const Messages = ({ onClick }) => {
  ...
  <div className="messages" onClick={onClick}>
    <div className="message-container" style={{ display: messages.length > 0 ? "none" : "block" }}>

      Пока что нет сообщений с этим пользователем<br />
      Отправте сообщение, чтобы начать общение (:
